<%@taglib prefix="sf" uri="http://www.smithstone.com/tags" %>
<%@taglib prefix="pa" tagdir="/WEB-INF/tags/apps/example/components/tags" %>

<sf:productFactory/>

<jsp:useBean id="product" type="example.domain.Product" scope="request"/>
